    ...
    <>
      ...
      <section className="max-w-7xl mx-auto px-6 mb-32">
        ...
        >
          ...
          <motion.div 
            variants={fadeInUp}
            className="group bg-surface-container-lowest rounded-lg overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-outline-variant/10 flex flex-col transition-all duration-300 hover:translate-y-[-4px]"
          >
