        ...
        >
          ...
          >
            ...
            <div className="h-56 bg-surface-container-low relative overflow-hidden">
              ...
              <div className="absolute top-4 left-4 bg-primary text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest">{t('vehicles.car.type')}</div>
            </div>
            <div className="p-8 grow flex flex-col">
              <h3 className="text-xl font-bold text-primary mb-2">{t('vehicles.car.name')}</h3>
              <p className="text-sm text-on-surface-variant mb-6 line-clamp-2">{t('vehicles.car.description')}</p>
              <div className="space-y-3 mb-8">
                <div className="flex items-center gap-3 text-xs">
                  <span className="material-symbols-outlined text-secondary text-lg">weight</span>
                  <span className="text-on-surface font-semibold">{t('vehicles.car.payload')}</span>
                </div>
                <div className="flex items-center gap-3 text-xs">
                  <span className="material-symbols-outlined text-secondary text-lg">straighten</span>
                  <span className="text-on-surface font-semibold">{t('vehicles.car.dimensions')}</span>
                </div>
              </div>
              <div className="mt-auto pt-6 flex items-center justify-between border-t border-surface-container">
                ...
                >
                  {selectedId === 'car' ? t('buttons.selected') : t('buttons.select')}
                </button>
                <a className="text-xs font-medium text-outline flex items-center gap-1 hover:text-primary transition-colors" href="#">
                  {t('buttons.specs')} <span className="material-symbols-outlined text-xs">arrow_forward</span>
                </a>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="h-56 bg-surface-container-low relative overflow-hidden">
              ...
              <div className="absolute top-4 left-4 bg-primary text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest">{t('vehicles.transporter.type')}</div>
            </div>
            <div className="p-8 grow flex flex-col">
              <h3 className="text-xl font-bold text-primary mb-2">{t('vehicles.transporter.name')}</h3>
              <p className="text-sm text-on-surface-variant mb-6 line-clamp-2">{t('vehicles.transporter.description')}</p>
              <div className="space-y-3 mb-8">
                <div className="flex items-center gap-3 text-xs">
                  <span className="material-symbols-outlined text-secondary text-lg">weight</span>
                  <span className="text-on-surface font-semibold">{t('vehicles.transporter.payload')}</span>
                </div>
                <div className="flex items-center gap-3 text-xs">
                  <span className="material-symbols-outlined text-secondary text-lg">straighten</span>
                  <span className="text-on-surface font-semibold">{t('vehicles.transporter.dimensions')}</span>
                </div>
              </div>
              <div className="mt-auto pt-6 flex items-center justify-between border-t border-surface-container">
                <button 
                ...
                >
                  {selectedId === 'transporter' ? t('buttons.selected') : t('buttons.select')}
                </button>
                <a className="text-xs font-medium text-outline flex items-center gap-1 hover:text-primary transition-colors" href="#">
                  {t('buttons.specs')} <span className="material-symbols-outlined text-xs">arrow_forward</span>
                </a>
          ...
          >
            ...
            <div className="h-56 bg-surface-container-low relative overflow-hidden">
              ...
              <div className="absolute top-4 left-4 bg-primary text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest">{t('vehicles.suitcase.type')}</div>
            </div>
            <div className="p-8 grow flex flex-col">
              <h3 className="text-xl font-bold text-primary mb-2">{t('vehicles.suitcase.name')}</h3>
              <p className="text-sm text-on-surface-variant mb-6 line-clamp-2">{t('vehicles.suitcase.description')}</p>
              <div className="space-y-3 mb-8">
                <div className="flex items-center gap-3 text-xs">
                  <span className="material-symbols-outlined text-secondary text-lg">weight</span>
                  <span className="text-on-surface font-semibold">{t('vehicles.suitcase.payload')}</span>
                </div>
                <div className="flex items-center gap-3 text-xs">
                  <span className="material-symbols-outlined text-secondary text-lg">straighten</span>
                  <span className="text-on-surface font-semibold">{t('vehicles.suitcase.dimensions')}</span>
                </div>
              </div>
              <div className="mt-auto pt-6 flex items-center justify-between border-t border-surface-container">
                <button 
                ...
                >
                  {selectedId === 'suitcase' ? t('buttons.selected') : t('buttons.select')}
                </button>
                <a className="text-xs font-medium text-outline flex items-center gap-1 hover:text-primary transition-colors" href="#">
                  {t('buttons.specs')} <span className="material-symbols-outlined text-xs">arrow_forward</span>
                </a>
          ...
          >
            ...
            <div className="h-56 bg-surface-container-low relative overflow-hidden">
              ...
              <div className="absolute top-4 left-4 bg-primary text-white text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest">{t('vehicles.suitcase_lift.type')}</div>
            </div>
            <div className="p-8 grow flex flex-col">
              <h3 className="text-xl font-bold text-primary mb-2">{t('vehicles.suitcase_lift.name')}</h3>
              <p className="text-sm text-on-surface-variant mb-6 line-clamp-2">{t('vehicles.suitcase_lift.description')}</p>
              <div className="space-y-3 mb-8">
                <div className="flex items-center gap-3 text-xs">
                  <span className="material-symbols-outlined text-secondary text-lg">weight</span>
                  <span className="text-on-surface font-semibold">{t('vehicles.suitcase_lift.payload')}</span>
                </div>
                <div className="flex items-center gap-3 text-xs">
                  <span className="material-symbols-outlined text-secondary text-lg">expand</span>
                  <span className="text-on-surface font-semibold">{t('vehicles.suitcase_lift.extra')}</span>
                </div>
              </div>
              <div className="mt-auto pt-6 flex items-center justify-between border-t border-surface-container">
                <button 
                ...
                >
                  {selectedId === 'suitcase_lift' ? t('buttons.selected') : t('buttons.select')}
                </button>
                <a className="text-xs font-medium text-outline flex items-center gap-1 hover:text-primary transition-colors" href="#">
                  {t('buttons.specs')} <span className="material-symbols-outlined text-xs">arrow_forward</span>
                </a>
        ...
        >
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-black text-primary mb-4 tracking-tight">{t('advantage.title')}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              <div className="flex flex-col items-center text-center">
                ...
                <h4 className="text-xl font-bold mb-3 text-primary">{t('advantage.features.tracking.title')}</h4>
                <p className="text-on-surface-variant text-sm leading-relaxed max-w-xs">{t('advantage.features.tracking.description')}</p>
              </div>
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-full bg-primary-fixed flex items-center justify-center mb-6">
                  <span className="material-symbols-outlined text-primary text-3xl">eco</span>
                </div>
                <h4 className="text-xl font-bold mb-3 text-primary">{t('advantage.features.eco.title')}</h4>
                <p className="text-on-surface-variant text-sm leading-relaxed max-w-xs">{t('advantage.features.eco.description')}</p>
              </div>
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-full bg-primary-fixed flex items-center justify-center mb-6">
                  <span className="material-symbols-outlined text-primary text-3xl">badge</span>
                </div>
                <h4 className="text-xl font-bold mb-3 text-primary">{t('advantage.features.drivers.title')}</h4>
                <p className="text-on-surface-variant text-sm leading-relaxed max-w-xs">{t('advantage.features.drivers.description')}</p>
              </div>
            </div>
          </div>
        </motion.section>
        ...
        >
          <div className="bg-primary rounded-xl overflow-hidden relative p-12 md:p-20 text-center">
            ...
            <div className="relative z-10">
              <h2 className="text-4xl md:text-5xl font-black text-white mb-8 tracking-tighter">{t('cta.title')}</h2>
              <p className="text-primary-fixed text-lg mb-12 max-w-2xl mx-auto opacity-90">
                {t('cta.description')}
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button onClick={() => router.push('/Price-Calculator')} className="bg-secondary-container cursor-pointer text-on-secondary-container px-10 py-4 rounded-md font-black text-lg shadow-lg active:scale-95 transition-transform">
                  {t('cta.plan_btn')}
                </button>
