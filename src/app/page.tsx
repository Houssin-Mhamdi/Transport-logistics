    ...
    <main className="min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-6 mb-32">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="group bg-surface-container-lowest rounded-lg overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-outline-variant/10 flex flex-col transition-all duration-300 hover:translate-y-[-4px]">
            ...
            <div className="p-8 flex-grow flex flex-col">
              ...
              <div className="mt-auto pt-6 flex items-center justify-between border-t border-surface-container">
                <button className="text-sm font-bold text-secondary-container hover:underline underline-offset-4 transition-all">Select Vehicle</button>
